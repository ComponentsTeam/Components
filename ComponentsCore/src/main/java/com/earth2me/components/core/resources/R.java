package com.earth2me.components.core.resources;

import com.earth2me.components.core.IContext;
import com.earth2me.components.core.util.FileExtension;
...
public final class R
{
	...
	/**
	 * Gets an unformatted string resource.
	 *
	 * @param resource the default English string resource; should have a {@code Resource} annotation.
	 */
	public static String string(String resource)
	{
		// TODO Use format.getHashCode() to look up the localized format.
		return resource;
	}
